...
from VirtualWorld_dataset import BlockWorld
...
# Configs
resume_path = '/export/data/vislearn/rother_subgroup/feiden/models/pretrained/ControlNet/control_sd21_2controls_ini.ckpt'  
